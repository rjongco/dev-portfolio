...
interface TransitionProps extends AnimatePresenceProps {
    children:  (props: { visible: boolean; status: string; nodeRef: React.RefObject<HTMLElement | null> }) => React.ReactNode   ,
    in: boolean,
    unmount?: boolean,
    timeout?: number
}
export const Transition = ({ children, in: show, unmount, initial = true, ...props }: TransitionProps) => {
